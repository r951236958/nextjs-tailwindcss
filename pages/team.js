...
export const Team = () => (
  <Layout>
    <div className="relative pt-16 pb-32 content-center items-center justify-center">
      <div className="py-10">
        <h1 className="text-5xl text-center text-gray-700 dark:text-gray-100">
          Terms of Service
        </h1>
      </div>
      <div className="lg:grid lg:grid-cols-1 lg:gap-12 lg:items-center">
        <div>
          <h2 className="my-2 text-4xl font-semibold font-display text-white">
        ...
        <div>
          ...
          <p className="text-lg text-gray-300 max-w-3xl">
            ...
            graphics, logos) is the property of [name] and/or its content
            ...
            property of [name], with copyright authorship for this compilation
            by [name].
          </p>
        </div>
        <div>
        ...
        <div>
          ...
          <p className="text-lg text-gray-300 max-w-3xl">
            ...
            come between [name] and you, or its business partners and
            associates.
          </p>
        </div>
        <div>
        ...
        <div>
          ...
          <p className="text-lg text-gray-300 max-w-3xl">
            ...
            such content. When you post your content, you grant [name]
