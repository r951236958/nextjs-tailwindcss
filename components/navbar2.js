	...
	return (
		<nav className="top-0 fixed z-50 w-full flex items-center justify-between flex-wrap bg-blueGray-600 p-3">
			<div className="flex items-center flex-shrink-0 text-white mr-6">
				...
				<Link href="/">
					<a className="font-semibold text-sm tracking-tight">Title</a>
				</Link>
			</div>
				...
				<div className="text-sm lg:flex-grow">
					{navLinks.map(({ href, linkTitle }) => (
						<Link
							...
							href={href}
						>
							<a className="block px-3 py-2 my-0 lg:inline-block text-gray-200 hover:text-white lg:mr-4 lg:my-2">{linkTitle}</a>
						</Link>
					))}
				</div>
				...
				<ul className="flex flex-col lg:flex-row list-none lg:ml-auto">
					<li className="nav-item">
						<Link
							href="/landing"
						>
						<a className="px-3 py-2 inline-flex items-center text-xs uppercase font-bold text-white hover:text-darkcyan-200 hover:opacity-75">
							<svg
					...
					<li className="nav-item">
						<Link
							...
							href="/colors"
						>
						<a className="px-3 py-2 inline-flex items-center text-xs uppercase font-bold text-white hover:opacity-75">
							<svg
								className="w-4 h-4 fill-current text-white opacity-75"
								viewBox="0 0 448 512"
							>
