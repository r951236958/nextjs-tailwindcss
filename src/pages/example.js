...
const Example = props => {
	return (
		<Layout>
			<div className="relative flex content-center justify-center mx-8 pb-32 pt-16 max-w-full text-gray-100 lg:max-w-2xl">
				<h1 className="py-10 text-white text-5xl">Example</h1>
				<div class="grid gap-4 grid-cols-2 w-full md:grid-cols-1">
					<div className="px-2">
