...
export default function Navbar({ fixed }) {
	...
	return (
		<>
			<nav className="navbar-expand-lg relative flex flex-wrap items-center justify-between mb-3 px-2 py-3 bg-gray-700">
						...
						<div className="flex items-center">
							...
							<div className="hidden md:block">
								<div className="flex items-baseline ml-10 space-x-4">
									<a
										className="whitespace-no-wrap flex inline-block mr-4 py-2 text-white text-sm font-bold leading-relaxed uppercase"
										href="/"
									>
						...
						<ul className="flex flex-col list-none lg:flex-row lg:ml-auto">
							{links.map(({ href, primary }) => (
								<li className="nav-item" key={primary}>
									<Link href={href}>
										<a className="flex items-center px-3 py-2 text-gray-300 hover:text-white text-sm font-medium leading-snug hover:bg-gray-700 focus:bg-gray-900 rounded-md">
											{primary}
										</a>
									</Link>
								</li>
							...
							<li className="nav-item">
								...
								>
									<svg
										...
										className="svg-inline--fa fa-facebook-square fa-w-14 leading-lg w-4 h-4 text-white text-lg fill-current opacity-75"
										xmlns="http://www.w3.org/2000/svg"
										viewBox="0 0 448 512"
									>
										<path
							...
							<li className="nav-item">
								...
								>
									<svg
										...
										data-prefix="fab"
										data-icon="twitter"
										className="svg-inline--fa fa-twitter fa-w-16 leading-lg w-4 h-4 text-white text-lg opacity-75"
										xmlns="http://www.w3.org/2000/svg"
										viewBox="0 0 512 512"
									>
										<path
							...
							<li className="nav-item">
								...
								>
									<svg
										...
										data-prefix="fab"
										data-icon="pinterest"
										className="svg-inline--fa fa-pinterest fa-w-16 leading-lg w-4 h-4 text-white text-lg opacity-75"
										xmlns="http://www.w3.org/2000/svg"
										viewBox="0 0 496 512"
									>
										<path
